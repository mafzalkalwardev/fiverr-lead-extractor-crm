...
PYTHON_AUTO_VERIFICATION_MAX_ATTEMPTS=8
PYTHON_PRESS_HOLD_SECONDS=8
PYTHON_VERIFICATION_TIMEOUT_SEC=900
PYTHON_AUTO_VERIFICATION_RECHECK_SEC=5
PYTHON_AUTO_VERIFICATION_RETRY_INTERVAL_SEC=10
...
"@ | Set-Content -LiteralPath $envFile -Encoding UTF8
    ...
    foreach ($key in $required.Keys) {
        if ($key -in @("MONGODB_URI", "REDIS_URL", "NEXT_PUBLIC_APP_URL", "NODE_ENV", "PYTHON_AUTO_VERIFICATION_MAX_ATTEMPTS", "ALLOW_OS_MOUSE_AUTOMATION", "FOCUS_BROWSER_ON_VERIFICATION")) {
